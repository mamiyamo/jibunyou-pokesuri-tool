...
const pokemonRectData: {[id: string]: RectElement[]} = {
    ...
    // Pumpkaboo (Small) 
    '29382': [
        {x: 0.292, y: 0.416, w: 0.416, h: 0.33, r: 0.15, color: '#eab2a2'},
        {x: 0.375, y: 0.58, w: 0.05, h: 0.083, r: 0.2, color: '#f6e864'},
        {x: 0.583, y: 0.583, w: 0.05, h: 0.083, r: 0.2, color: '#f6e864'},
        {x: 0.167, y: 0.375, w: 0.667, h: 0.167, r: 0.15, color: '#816a58'},
        {x: 0.375, y: 0.21, w: 0.25, h: 0.33, r: 0.15, color: '#816a58'}
    ],
    // Pumpkaboo (Medium)
    '33478': [
        {x: 0.25, y: 0.4, w: 0.5, h: 0.4, r: 0.15, color: '#eab2a2'},
        {x: 0.34, y: 0.6, w: 0.07, h: 0.1, r: 0.2, color: '#f6e864'},
        {x: 0.59, y: 0.6, w: 0.07, h: 0.1, r: 0.2, color: '#f6e864'},
        {x: 0.1, y: 0.35, w: 0.8, h: 0.2, r: 0.15, color: '#816a58'},
        {x: 0.35, y: 0.15, w: 0.3, h: 0.4, r: 0.15, color: '#816a58'}
    ],
    // Pumpkaboo (Large)
    '37574': [
        {x: 0.208, y: 0.375, w: 0.583, h: 0.458, r: 0.16, color: '#eab2a2'},
        {x: 0.31, y: 0.625, w: 0.1, h: 0.117, r: 0.2, color: '#f6e864'},
        {x: 0.59, y: 0.625, w: 0.1, h: 0.117, r: 0.2, color: '#f6e864'},
        {x: 0.042, y: 0.333, w: 0.917, h: 0.233, r: 0.15, color: '#816a58'},
        {x: 0.333, y: 0.125, w: 0.333, h: 0.4, r: 0.15, color: '#816a58'}
    ],
    // Pumpkaboo (Jumbo)
    '41670': [
        {x: 0.167, y: 0.35, w: 0.667, h: 0.517, r: 0.18, color: '#eab2a2'},
        {x: 0.29, y: 0.65, w: 0.12, h: 0.133, r: 0.2, color: '#f6e864'},
        {x: 0.59, y: 0.65, w: 0.12, h: 0.133, r: 0.2, color: '#f6e864'},
        {x: 0, y: 0.3, w: 1, h: 0.267, r: 0.15, color: '#816a58'},
        {x: 0.3, y: 0.08, w: 0.4, h: 0.4, r: 0.15, color: '#816a58'}
    ],
    // Pumpkaboo (Small) 
    '29383': [
        {x: 0.24, y: 0.58, w: 0.52, h: 0.42, r: 0.18, color: '#836c59'},
        {x: 0.41, y: 0.18, w: 0.18, h: 0.45, r: 0.1, color: '#e5c786'},
        {x: 0.2, y: 0.18, w: 0.1, h: 0.55, r: 0.05, color: '#ebb3a0'},
        {x: 0.68, y: 0.18, w: 0.1, h: 0.55, r: 0.05, color: '#ebb3a0'},
        {x: 0.22, y: 0.18, w: 0.56, h: 0.1, r: 0.05, color: '#ebb3a0'}
    ],
    // Pumpkaboo (Medium)
    '33479': [
        {x: 0.2, y: 0.55, w: 0.6, h: 0.45, r: 0.2, color: '#836c59'},
        {x: 0.4, y: 0.1, w: 0.2, h: 0.5, r: 0.1, color: '#e5c786'},
        {x: 0.2, y: 0.1, w: 0.1, h: 0.6, r: 0.05, color: '#ebb3a0'},
        {x: 0.7, y: 0.1, w: 0.1, h: 0.6, r: 0.05, color: '#ebb3a0'},
        {x: 0.2, y: 0.1, w: 0.6, h: 0.1, r: 0.05, color: '#ebb3a0'}
    ],
    // Pumpkaboo (Large)
    '37575': [
        {x: 0.15, y: 0.52, w: 0.68, h: 0.48, r: 0.2, color: '#836c59'},
        {x: 0.38, y: 0.05, w: 0.24, h: 0.55, r: 0.1, color: '#e5c786'},
        {x: 0.18, y: 0.05, w: 0.1, h: 0.6, r: 0.05, color: '#ebb3a0'},
        {x: 0.72, y: 0.05, w: 0.1, h: 0.6, r: 0.05, color: '#ebb3a0'},
        {x: 0.2, y: 0.05, w: 0.6, h: 0.1, r: 0.05, color: '#ebb3a0'}
    ],
    // Pumpkaboo (Jumbo)
    '41671': [
        {x: 0.12, y: 0.48, w: 0.74, h: 0.52, r: 0.22, color: '#836c59'},
        {x: 0.38, y: 0, w: 0.24, h: 0.58, r: 0.1, color: '#e5c786'},
        {x: 0.16, y: 0, w: 0.12, h: 0.6, r: 0.05, color: '#ebb3a0'},
    ...
    // Cutiefly
    '742': [
        {x: 0, y: 0, w: 1, h: 1, color: '#ffe85f'},
        {x: 0.1, y: 0.25, w: 0.8, h: 0.6, r: 0.4, color: '#f9f9f9'},
        {x: 0.06, y: 0.38, w: 0.28, h: 0.37, r: 0.3, color: '#3f3f3f'},
        {x: 0.12, y: 0.48, w: 0.08, h: 0.08, r: 0.02, color: '#f9f9f9'},
        {x: 0.2, y: 0.58, w: 0.08, h: 0.08, r: 0.02, color: '#d3a885'},
        {x: 0.64, y: 0.38, w: 0.28, h: 0.37, r: 0.3, color: '#3f3f3f'},
        {x: 0.78, y: 0.48, w: 0.08, h: 0.08, r: 0.02, color: '#f9f9f9'},
        {x: 0.7, y: 0.58, w: 0.08, h: 0.08, r: 0.02, color: '#d3a885'},
    ],
    // Ribombee
    '743': [
        {x: 0, y: 0, w: 1, h: 1, color: '#ffe85f'},
        {x: 0.1, y: 0.1, w: 0.8, h: 0.6, r: 0.4, color: '#f9f9f9'},
        {x: 0.08, y: 0.23, w: 0.28, h: 0.37, r: 0.3, color: '#3f3f3f'},
        {x: 0.17, y: 0.31, w: 0.08, h: 0.08, r: 0.02, color: '#f9f9f9'},
        {x: 0.18, y: 0.43, w: 0.08, h: 0.08, r: 0.02, color: '#d3a885'},
        {x: 0.64, y: 0.23, w: 0.28, h: 0.37, r: 0.3, color: '#3f3f3f'},
        {x: 0.75, y: 0.31, w: 0.08, h: 0.08, r: 0.02, color: '#f9f9f9'},
        {x: 0.74, y: 0.43, w: 0.08, h: 0.08, r: 0.02, color: '#d3a885'},
        {x: 0, y: 0.65, w: 1, h: 0.5, color: '#997558'},
        {x: 0.3, y: 0.7, w: 0.4, h: 0.5, r: 0.1, color: '#ffe85f'},
        {x: 0.3, y: 0.88, w: 0.4, h: 0.5, color: '#f9f9f9'},
    ],
    // Stufful
    '759': [
